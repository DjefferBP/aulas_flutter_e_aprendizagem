...
import 'package:app_teste_1/exercicios_base/tarefa.dart';
        ...
        return StatefulBuilder(
          builder: (context, setStateModal){
            bool validarESalvar() {
              ...
              setState(() { // atualiza a lista principal
            ...
            child: Scrollbar(
              ...
              itemBuilder: (context, index){
                ...
                return ListTile(
                  ...
                  title: Text("${tarefa.nome}", style: TextStyle(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        icon: tarefa.concluida ? Icon(Icons.check_box)  : Icon(Icons.check_box_outline_blank),
